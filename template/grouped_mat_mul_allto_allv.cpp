...
class GroupedMatMulAlltoAllvTilingParam : public ::testing::TestWithParam<GroupedMatMulAlltoAllvTilingTestParam> {
protected:
...
std::vector<gert::TilingContextPara::TensorDescription> CreateInputTensors(
    const GroupedMatMulAlltoAllvTilingTestParam& param,
...
void TestOneParamCase(const GroupedMatMulAlltoAllvTilingTestParam &param)
{
...
TEST_P(GroupedMatMulAlltoAllvTilingParam, general_case)
{
...
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GroupedMatMulAlltoAllvTilingParam);

/*
INSTANTIATE_TEST_SUITE_P(
    general_cases_params,
    GroupedMatMulAlltoAllvTilingParam,
